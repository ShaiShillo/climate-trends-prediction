...
## Data Source
--------------
The data used for this project was obtained from [https://www.wunderground.com/]. The dataset includes It contains [102,655] samples of global temperature measurements, spanning from [2015] to [2023]. Each sample includes ['Year', 'Month', 'Day', 'Temperature', 'Temp Dew Point', 'Humidity', 'Wind Direction', 'Wind Speed', 'Precipitation', 'Condition', 'Location', 'Serialized Hemisphere']. 
